...
var vcHome = function vcHome(resolve) {
  return __webpack_require__.e/* import() */(4).then(__webpack_require__.bind(null, 7)).then(resolve);
};
var vcRadios = function vcRadios(resolve) {
  return __webpack_require__.e/* import() */(1).then(__webpack_require__.bind(null, 8)).then(resolve);
};
var vcRadiosCategory = function vcRadiosCategory(resolve) {
  return __webpack_require__.e/* import() */(0).then(__webpack_require__.bind(null, 9)).then(resolve);
};
var vcRadiosId = function vcRadiosId(resolve) {
  return __webpack_require__.e/* import() */(2).then(__webpack_require__.bind(null, 10)).then(resolve);
};
var vcGlobal404 = function vcGlobal404(resolve) {
  return __webpack_require__.e/* import() */(3).then(__webpack_require__.bind(null, 11)).then(resolve);
};
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__styles_main_scss__ = __webpack_require__(3);
